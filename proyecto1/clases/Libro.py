...
class Libro:
    ...
    def setAutor(self, autor): self.__nombreAutor = autor
    def getTitulo(self): return self.__titulo
    def setTitulo(self, titulo): self.__titulo = titulo

    def __str__(
        self): return f"Libro: ({self.__isbn}, {self.__titulo}, {self.__edicion}, {self.__year}, {self.__editorial}, {self.__genero}, {self._idioma}, {self.__nCopias}, {self.__activo}, {self.__categoria}, {self.__nombreAutor})"

    def registrar(self, listaAutores, listaCopias):
        try:
            self.__isbn = int(input("Ingrese el ISBN del nuevo libro: "))
            autorNombre = input(
                "Ingrese el nombre del autor del nuevo libro: ")
            contador = 1
            ...
            if (contador > len(listaAutores)):
                ...
                if (siono.upper() == 'S'):
                    ...
                    print("Creacion de libro cancelado")
                    return 0
    ...
    def modificar(self, listaAutores):
        ...
        if (eleccion == 1):
            try:
                self.__isbn = int(input("Ingresa el nuevo ISBN: "))
            except ValueError:
            ...
            autorNombre = input("Ingrese el nombre del nuevo autor: ")
            contador = 1
            ...
            if (contador > len(listaAutores)):
                ...
                if (siono.upper() == 'S'):
                    ...
                    print("Modificación del autor del libro cancelado")
                    return 0
